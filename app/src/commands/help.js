...
const HELP = [
  ...
  "`ginventory [page] [rarity] [sort:value|rarity|power] [q:name]` — your collectibles 🎒",
  "`gcollection [page] [rarity] [sort:value|rarity|power] [q:name]` — all collectibles 📖",
